...
from models.model_tools import create_model, load_model
from models.Losses.utils import flip_tensor, flip_lr_off, flip_lr
...
class Detector_RGBT(object):
    def __init__(self, opt):
        ...
        self.model = create_model(opt=opt)
    ...
    def process(self, vi_images, ir_images, pre_vi_images=None, pre_ir_images=None, pre_hms=None,
        ...
        with torch.no_grad():
            torch.cuda.synchronize()
            output = self.model(vi_images, ir_images, pre_vi_images, pre_ir_images, pre_hms)[-1][-1]
